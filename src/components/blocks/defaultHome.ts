...
export const defaultHomeLayout: RenderableBlock[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How much are the fees?', a: 'We keep fees transparent, with no hidden capital-fee surprises. Call us on 09 81 99 99 22 and our admissions team will talk you through the fees for your child’s grade.' },
