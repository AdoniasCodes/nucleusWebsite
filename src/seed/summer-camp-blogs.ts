...
const posts: SeedPost[] = [
  {
    ...
    body: [
      ...
      { p: 'It runs from July 6 to August 12, across our Mekanisa and Vatican campuses in Addis Ababa, for children aged 4 to 14. Six weeks of real activity, real skills and real friendships, and learning that never feels like school.' },
      { h2: 'What your child will actually do' },
      { p: 'Campers rotate through a full, balanced week of hands-on activities, each led by a specialist. No idle afternoons, no endless screen time, just a genuine mix of mind, body and imagination:' },
      { ul: [
